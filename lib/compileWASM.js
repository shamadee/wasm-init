...
function compileWASM (config, exp=false) {
  ...
  // export bash environment variables and directories to node process
  // when recompiling
  let exporting = exp ? 'export' : '';
